...
impl XdgPortalAuthService {
    ...
    fn make_credential(
        ...
        *guard = Some(TransactionState {
        ...
        RunnableBuilder::new("XdgPortalService::MakeCredential::DbusSend", move || {
            ...
            let parent_window = String::new(); // We don't know it yet
            let result = dbus_controller.send_create_credential(&parent_window, req);
    ...
    fn do_get_assertion(
        ...
        RunnableBuilder::new("XdgPortalService::GetCredential::DbusSend", move || {
            ...
            let parent_window = String::new(); // We don't know it yet
            let result = dbus_controller.send_get_credential(&parent_window, req);
